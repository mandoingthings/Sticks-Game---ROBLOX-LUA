...
local ExtendFrame = Hotbar:FindFirstChild("StatsFrame")




script.Parent.MouseButton1Click:Connect(function()
		if StatsScreen.Visible == false then
		...
		StatsScreen:WaitForChild("ResetButton"):WaitForChild("Frame").Visible = false
		else
